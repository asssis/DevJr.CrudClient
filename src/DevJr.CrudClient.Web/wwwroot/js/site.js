...
window.onload = (event) => { 
    ...
    if (estados)
    {
        ...
        json_estados.estados.forEach(function (estado) {
            var cid_opts = document.createElement('option');
            cid_opts.setAttribute('value', estado.sigla)
            cid_opts.innerHTML = estado.nome;
            estados.appendChild(cid_opts);
        });
...
function buscaCidades(e) {
    ...
    var cidade_select = document.getElementById("cidade");
